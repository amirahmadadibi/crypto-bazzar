...
Future<void> setupLocator() async {
  ...
  locator.registerFactory<CoinDatasource>(() => CoinRemoteDatasource(locator<Dio>()));
  //repository
 locator.registerFactory<CoinListRepository>(() => CoinRepository(locator<CoinDatasource>()));
